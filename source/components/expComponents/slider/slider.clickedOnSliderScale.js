...
function clickedOnSliderScale(mouseEvent) {
  ...
  const $tooltipValue = $($scale.querySelector('[data-lever-component="tooltip-value"]'));
  const $fill = $($scale.querySelector('[data-scale-component="fill"]'));
  const $lever = $($scale.querySelector('[data-lever-component="lever"]'));
